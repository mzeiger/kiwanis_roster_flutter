...
try {
  ...
  */
  ...
  $sql = "select first_name as firstname,  'x' as middlename, last_name as lastname, spouse as cb_spousename, street_address as cb_address,
            ...
            'https://monumenthillkiwanis.org/wp-mhk/wp-content/uploads/2026/05/cropped-mhk_std_logo_640_transparent_smaller.png' as avatar, 
            enabled as block
            from v_user_info order by lastname";
...
exit;
ho json_encode(array('members' => $members));
